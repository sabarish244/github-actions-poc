...
$keyVaultName="devops-metrics-eu-vault"
$storageName="devopsmetricseustorage"
$hostingName="devops-metrics-eu-hosting"
$appInsightsName="devops-metrics-eu-appinsights"
$serviceName="devops-metrics-eu-service"
$websiteName="devops-metrics-eu-web"
$functionName="devops-metrics-eu-function"
$administrationEmailAccount="sabarish.ramasubramanian@expleogroup.com"
$fileRoot = "C:\Files\beazley-devops\DevOpsMetrics-main\src"
